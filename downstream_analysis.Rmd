...
library(dplyr)
#define study path
save_path <- "D:/GoogleDrive/spatial_leishmania/spatial/_MANUSCRIPTS/CHIM1/GITHUB_PLAYGROUND/"#"Add your path here"
setwd(save_path)
...
ptm <- proc.time()
#PLotting Figure 6a
pdf(paste0(save_path, "Fig6a.pdf"), height = 5, width = 20)
  SpatialDimPlot(cluster2only, images = "LC_403_1C2", crop = F, ncol = 2, image.alpha = 0)
dev.off()
#PLotting Figure 6b
